		...
		<div class="row">
				<div class="col-lg-9 herocareer">
					<div class="section boxes">
						...
						<p>Fast Phone Repair offers a full range of repair options for all mobile devices.</p><a href="contact.php" title="Quote"><button class="herocareer-button">Get Quote Now</button></a>
					</div>
				</div>
	</div>
